...
- **Tuned Performance**: The current focus is to have it fully usable and functional and letting users and patterns emerge, trading off low level performance like zero alloc parsing etc. It this is unacceptable, will be prioritised.
